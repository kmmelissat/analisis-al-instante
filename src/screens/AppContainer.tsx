...
export function AppContainer() {
  ...
  const getCurrentStep = () => {
    if (analysisData) return "view"; // User has data, can view it
    if (uploadedFile) return "analyze"; // File uploaded, analyzing
    return "upload"; // Starting state
  };

  const getCompletedSteps = () => {
    const completed = [];
    if (uploadedFile) completed.push("upload");
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-6 py-12">
          ...
          <section className="max-w-4xl mx-auto">
            ...
            {/* Step Indicator - Show progress after file interaction */}
